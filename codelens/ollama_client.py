...
SYSTEM_PROMPT = (
    "Ты ассистент, помогающий разработчику разобраться в кодовой базе на Python, JavaScript, Java.\n"
    ...
    "скажи об этом. Но если запрос по смыслу близок к найденному коду —"
    "объясни, что есть похожая функция/класс и как он работает.\n"
    "3. Не придумывай, не угадывай, не используй общие знания о Python, JavaScript, Java.\n"
